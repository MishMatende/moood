  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-5 gap-4">
        ...
        <p
          className={
            "text-center capitalized col-span-3 whitespace-nowrap text-gradient " +
            fugaz.className
          }
        >
              ...
              {dayList.map((dayOfWeek, dayOfWeekIndex) => {
                ...
                return (
                  <div
                    ...
                    className={
                      "text-xs sm:text-sm border border-solid p-2 flex items-center gap-2 jusitfy-between rounded-lg " +
